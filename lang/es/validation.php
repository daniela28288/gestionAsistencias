...
return [
    ...
    'custom' => [
        'program_code' => [
            'regex' => 'El Código del Programa solo puede contener números.',
            'unique' => 'El Código del Programa debe ser único.',
            'min' => 'El Código del Programa debe contener al menos 6 caracteres.'
        ],

        'program_version' => [
            'regex' => 'La Versión del Programa debe ser un número entero.',
        ],

        'name' => [
            'min' => 'El Nombre del Programa debe contener al menos 6 caracteres.'
        ]
    ],
    ...
    'attributes' => [
        ...
        'id_level' => 'Nivel del Programa',
        'instructor_id' => 'Instructor Responsable',
    ],
];
